...
public class DriveInCircle extends Command {
    ...
    public void execute() {
        ...
        // ie., represent the rotational speed as proportional to the angular velocity
        // of the orbit
        ...
        // Linear acceleration constraint (divided by 2, since I want to be extra
        ...
        // Move the robot's translation along the circle based on the desired linear
        // speed
        ...
        Rotation2d targetRotation = previousPose.getRotation()
                .rotateBy(new Rotation2d(rotationalSpeed * Constants.PERIOD));
        ...
        // Twist2d targetVelocity = previousPose.log(targetPose); // NOTE: generates the
        // DISPLACEMENT twist, not a velocity
        ...
        // }
        // DriveTrajectory trajectory = new DriveTrajectory(positionTrajectory,
        // velocityTrajectory);

...
public class QuadraticProfile {
    ...
    // public ArrayList<double[]> getSetPoints(Translation2d initialPosition, Translation2d goal, double theta, double speed, double acceleration, ArrayList<Translation2d> guides) {        
    ...
    public Translation2d[] getCombinedSetPoints(Translation2d initialPosition, Translation2d goal, double speed, double acceleration) {
    ...
    // public ArrayList<double[]> getSetPoints(Translation2d initialPosition, Translation2d goal, double theta, double speed, double acceleration) {
    //     double directionX, directionY;
        
    //     Translation2d[] combined = getCombinedSetPoints(initialPosition, goal, theta, speed, acceleration);
    ...
    public Translation2d[] combineSetPoints(Translation2d[] accel, Translation2d[] constant, Translation2d[] stopping, Translation2d initialPosition) {
        ...
        for(int i = 0; i < stopping.length; i++) {
            combined[i + accel.length + constant.length] = stopping[i].plus(combined[accel.length + constant.length - 1]); 
        }
